# -*- coding: utf-8 -*-
"""
S2：提高 SAM3 confidence_threshold（更严格、更少触发）
目的：验证 teacher prior “质量 vs 覆盖率”权衡：更严格是否更好，还是覆盖更关键
"""

dataset = 'pathology2'
output_dir = 'outputs/pathology_ablation/S2_stage2_gate_sam3_high_th'
...
# 关键：更严格
sam3_confidence_threshold = 0.90
