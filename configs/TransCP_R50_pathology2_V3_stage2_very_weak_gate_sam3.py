# -*- coding: utf-8 -*-
"""
V3 超弱注入：Stage2 注入视觉 cue，但 gate_init 更小（更保守）
目的：验证性能是否对“注入强度/学习速度”敏感
"""

dataset = 'pathology2'
output_dir = 'outputs/pathology_ablation/V3_stage2_very_weak_gate_sam3'
...
# gate_init=-8 => sigmoid≈0.0003：几乎完全不注入，学习更慢
fusion_gate_init = -8.0
fusion_nheads = 8
fusion_dropout = 0.1
