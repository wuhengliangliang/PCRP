# -*- coding: utf-8 -*-
"""
S1：SAM3 不用 GT prompt（训练中也不混 GT），全程使用 b0 预测框作为 prompt
目的：验证 SAM3 的 curriculum（GT warmup/mix）是否关键，排除“偷看 GT”的质疑
"""

dataset = 'pathology2'
output_dir = 'outputs/pathology_ablation/S1_stage2_gate_sam3_no_gt_prompt'
...
# 关键：禁用 GT prompt
sam3_prompt_use_gt_when_training = False
sam3_prompt_warmup_epochs = 0
sam3_prompt_mix_epochs = 0
