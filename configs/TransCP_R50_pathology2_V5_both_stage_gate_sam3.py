# -*- coding: utf-8 -*-
"""
V5 Both stages：Stage1 + Stage2 都注入视觉 cue
目的：验证是否“早期注入 + 后期注入”叠加更好，还是会相互干扰
"""

dataset = 'pathology2'
output_dir = 'outputs/pathology_ablation/V5_both_stage_gate_sam3'
