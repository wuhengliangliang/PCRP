# -*- coding: utf-8 -*-
"""
V2 强注入：Stage2 注入视觉 cue，但 gate_init 很大（初始强注入）
目的：对比 V1，验证 gate 的“稳定训练价值”
现象预期：可能更不稳/更容易抖动，但如果仍提升说明 cue 很强；若掉点说明稳定性靠 gate
"""

dataset = 'pathology2'
output_dir = 'outputs/pathology_ablation/V2_stage2_strong_inject_sam3'
...
# gate_init=+4 => sigmoid≈0.982：训练初期就强注入（近似 fixed gate=1）
